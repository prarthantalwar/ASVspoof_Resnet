...
class ASVspoof2019(Dataset):
    def __init__(self, access_type, path_to_features, path_to_protocol, part='train', feature='SFFCC',
    ...
    def __getitem__(self, idx):
        ...
        try:
            with open(self.ptf + '/_'+ filename + self.feature + '.pkl', 'rb') as feature_handle:
            ...
            def the_other(train_or_dev):
                ...
                return res
            with open(os.path.join(self.path_to_features, the_other(self.part)) + '/_'+ filename + self.feature + '.pkl', 'rb') as feature_handle:
                feat_mat = pickle.load(feature_handle)
...
if __name__ == "__main__":
    ...
    path_to_features = '/media/serb-s2st/PortableSSD/Resnet/Features/'  # if run on GPU
    path_to_protocol = '/home/serb-s2st/workspace/matlab/PRT_SFF_Files/ASVspoof2019_root/LA/ASVspoof2019_LA_cm_protocols/'
